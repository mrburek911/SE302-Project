 ...
 * This is a stable informational page and avoids stock/cart volatility.
 */
export class FaqPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    // The page includes heading "ČESTA PITANJA"
    this.heading = this.page.getByRole("heading", { name: /česta pitanja/i }).first();

    // Support contact details shown in FAQ content.
